...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        action_choiced = actions[0]
        action_choiced_value = self.getQValue(state, action_choiced)
        for action in actions[1:] :
          action_value = self.getQValue(state, action)
          if action_value >= action_choiced_value:
              action_choiced = action
              action_choiced_value = action_value
        
        return action_choiced
